/* =========================================
   THE PIONEER — Content Data
   Edit this file to update the website.
   First article is always the featured hero.
   ========================================= */

const SITE = {

  name: "The Pioneer",
  tagline: "Thoughts worth reading.",
  ...
  articles: [
    ...
    },
    {
      ...
      author: "Lena Sorenson",
      date: "April 11, 2026",
      readTime: "8 min read",
      image: "images/sky_scraper.jpeg",
      imageAlt: "City streets",
      body: `
        <p>Walk through any major city today and you'll notice something. The streets feel different than they did ten years ago. Not everywhere, not all at once — but the change is there if you look for it. A parking lane converted to a protected bike path. A wide boulevard narrowed to make room for trees and benches. A highway ramp quietly demolished, replaced by a park.</p>

        <p>These aren't accidents. They're the result of a slow, often contentious movement that has been building for decades — a movement to reclaim public space from the car and return it to the people who actually live in cities.</p>

        <h2>The car's century</h2>

        <p>For most of the twentieth century, urban planning in the West operated on a single assumption: that the future belonged to the automobile. Cities were redesigned around it. Highways were punched through historic neighborhoods. Sidewalks were narrowed. Parking minimums were written into law, ensuring that vast swaths of land in every city would be paved over and left empty most of the time.</p>

        <p>The consequences were enormous — and not just environmental. The prioritization of car travel fundamentally changed the texture of city life. Streets that had once been shared spaces became dangerous to cross. Neighborhoods were cut off from each other by six-lane roads. Children stopped playing outside. The simple act of walking to a shop became, in many places, an act of minor bravery.</p>

        <h2>The turn</h2>

        <p>The shift started quietly. In the 1990s, a handful of cities in Europe — Amsterdam, Copenhagen, Zurich — began making different choices. They invested in cycling infrastructure, restricted car access to city centers, and redesigned public spaces around pedestrians. The results, over time, were dramatic: cleaner air, fewer traffic deaths, more vibrant street life, stronger local economies.</p>

        <p>The idea spread slowly at first, then faster. Today, cities from Oslo to Seoul to Bogotá have undertaken ambitious projects to reduce car dominance. In Paris, Mayor Anne Hidalgo has removed tens of thousands of parking spaces and converted expressways along the Seine into pedestrian promenades. In New York, Times Square — once a chaotic traffic interchange — is now a pedestrian plaza.</p>

        <h2>Why it matters</h2>

        <p>The stakes are higher than they might appear. How we design our streets shapes how we live. Streets that prioritize cars produce a certain kind of city: one where you need a car to participate in daily life, where chance encounters with neighbors are rare, where children grow up in the backseat rather than on the sidewalk.</p>
