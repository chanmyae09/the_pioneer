  ...
  articles: [
    {
      ...
      body: `
        ...
        <blockquote>"All taxes shall be uniform upon the same class of property within the territorial limits of the authority levying the tax, and shall be levied and collected for public purposes only. The word "property" as used herein shall mean and include everything, whether tangible or intangible, subject to ownership."</blockquote>

        <p>This means that our state must tax everyone at the same rate. But there is another problem: in 1933, the Washington State Supreme Court ruled in <em>Culliton vs Chase</em> that a progressive state income tax is unconstitutional. The judges stated,</p>

        <blockquote>"Property" is "everything, whether tangible or intangible, subject to ownership." … There being no other classifications in our Constitution but real and personal property and intangible property, incomes necessarily fall within the category of intangible property. No more positive, precise, and compelling language could have been used. It needs no technical construction to tell what those words mean. The overwhelming weight of judicial authority is that "income" is property and a tax upon income is a tax upon property."</blockquote>

        <p>This ruling defines income as property — meaning, income must be taxed at a uniform rate. Another problem with this tax is Initiative 2111 (passed just last year) which banned income taxes from Washington state. The necessity clause in SB 6346 which prevents referendums also raises many questions; it is a fascinating use of an emergency clause, given the bill doesn't start collecting taxes until 2029.</p>

        <p>This new tax mania is due to the fact that Washington state has a spending problem — despite our state collecting record levels of revenue, it still runs a deficit. Which is funny because before COVID, our state had a surplus. This is all due to highly unnecessary spending, like $4.3 million on trans prisoner surgeries and spending $20,000 on the Pan Eros foundation, which operates Seattle Jacks, which are self-pleasuring rooms for men. Another drain on our state budget is the constant lawsuits against the Department of Youth and Families Services (DCYF) who last year cut the Pediatric Interim Care Center, a center which helps cure drug-addicted babies. Another thing is that DCYF has been inauditable for 5 years (according to the Washington State auditor report) and has an estimated 2 million dollars for fraud through over payments <em>alone</em>. Washington state also cut around $750 million for Medicaid.</p>

        <p>This is a financial emergency, not due to insufficient tax revenue, but due to a spending addiction — and SB 6346 is not the answer. Proper budgeting is the answer.</p>
      `,
    },
    {
